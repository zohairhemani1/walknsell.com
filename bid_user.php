			  ...
			  <tbody>
				...
				<tr>
				  <td><table align='center' style='max-width:650px'>
					  <tbody>
						<tr>
						  <td style='color:#b4b4b4;font-size:11px;padding-top:10px;line-height:15px;font-family:arial'> Р’В© Avialdo 2014-2016, WalkNSellР’В®, DealР’В®, DealSР’В®, WalkNSell graphics, logos, scripts, terms of use, instructions, designs and others service names are the trademarks and copyright of Avialdo.</td>
						</tr>
					  </tbody>
					</table></td>
				</tr>
...
/* FiverrР’В® is located at 460 Park Avenue, New York, NY10016. <br>
