			  ...
			  <tbody>
				<tr>
				  <td><table align='center' cellspacing='0' style='max-width:650px;min-width:320px'>
					  <tbody>
						<tr>
						  <td style='text-align:left;padding-bottom:14px'><img align='left' alt='WalkNSell' src='https://ci5.googleusercontent.com/proxy/aHAvPRQ40UGPkcIi9S-UF0YMlSHhr_420DfoVQjfJ6kKQEgABq0C_4x6KRw7u8LkEBAOABKOuiqXfEAEmmCX4ezn7dE62U9tA6-XtJuZJ-JrPDZcq5PSOS5e=s0-d-e1-ft#http://d2nt7j7ljjsiah.cloudfront.net/assets/v2_emails/email_logo.png'></td>
						</tr>
						<tr>
						...
						<tr>
						  <td align='center' style='background:#f8f8f8;border:1px solid #e4e4e4;border-top:none;padding:24px 10px'><table align='center' style='width:100%;max-width:650px'>
							  <tbody>
								...
								<tr>
								  <td style='font-size:20px;line-height:27px;text-align:center;max-width:650px'><a href='' style='text-decoration:none;color:#69696c' target='_blank'> <span style='color:#00ce00;font-weight:bold;max-width:180px'>NEW!</span> All the Gigs<sup style='font-size:14px'>®</sup> You Need <br>
